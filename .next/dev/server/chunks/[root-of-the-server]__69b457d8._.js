...
async function GET(request) {
    try {
        ...
        const discussions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].discussion.findMany({
            where: {
                OR: [
                    {
        ...
        const conversations = discussions.map((discussion)=>{
            const otherUser = discussion.user1Id === currentUser.id ? discussion.user2 : discussion.user1;
...
async function POST(request) {
    try {
        ...
        const otherUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                id: otherUserId
            }
        });
        ...
        const existingDiscussion = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].discussion.findFirst({
            where: {
                OR: [
                    {
                        user1Id: currentUser.id,
        ...
        if (existingDiscussion) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(existingDiscussion, {
                status: 200
            });
        }
        // Create new discussion
        const discussion = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].discussion.create({
            data: {
                user1Id: currentUser.id,
                user2Id: otherUserId
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69b457d8._.js.map