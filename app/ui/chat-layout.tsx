...
export default function ChatLayout() {
  ...
  return (
    <div className="h-screen flex bg-gray-100 overflow-hidden">
      ...
      <div className="w-full md:w-64 bg-white border-r border-gray-200 overflow-y-auto flex flex-col">
        {/* Header */}
                ...
                {selectedFile && previewUrl && (
                  <div className="mb-3">
                    <div className="flex items-start gap-3">
                      <div className="max-w-xs max-h-48 overflow-hidden rounded">
                        {selectedFile.type.startsWith("image/") ? (
                          ...
                          <div className="w-48 h-32 flex items-center justify-center bg-gray-50 border rounded text-sm text-gray-600">
